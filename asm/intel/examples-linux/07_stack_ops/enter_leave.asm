; ============================================================
; 文件: 07_stack_ops/enter_leave.asm                       [Linux 版]
; 指令: ENTER / LEAVE
; 描述: 一条指令建立栈帧 —— 与 push rbp; mov rbp,rsp; sub rsp,N 完全等价
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/07_stack_ops/enter_leave.asm -o build/enter_leave.o
; 链接: gcc -no-pie build/enter_leave.o -o build/enter_leave
