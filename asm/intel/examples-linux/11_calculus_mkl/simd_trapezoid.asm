; ============================================================
; 文件: 11_calculus_mkl/simd_trapezoid.asm                 [Linux 版]
; 指令: MULPS / ADDPS / MULSS / ADDSS / MOVUPS / SHUFPS / RDTSC
; 描述: 梯形法数值积分 —— 标量 vs SIMD，用 RDTSC 量出真实差距
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/11_calculus_mkl/simd_trapezoid.asm -o build/simd_trapezoid.o
; 链接: gcc -no-pie build/simd_trapezoid.o -o build/simd_trapezoid
