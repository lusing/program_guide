; ============================================================
; 文件: 06_string_ops/movsb.asm                            [Linux 版]
; 指令: MOVSB / REP MOVSB
; 描述: 字符串移动 —— 单字节复制与「整段 memcpy」
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/06_string_ops/movsb.asm -o build/movsb.o
; 链接: gcc -no-pie build/movsb.o -o build/movsb
