; ============================================================
; 文件: 06_string_ops/rep_prefix.asm                       [Linux 版]
; 指令: REP / REPE / REPNE 前缀综合演示
; 描述: 用硬件循环一口气完成 memcpy / memset / memcmp / strlen
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/06_string_ops/rep_prefix.asm -o build/rep_prefix.o
; 链接: gcc -no-pie build/rep_prefix.o -o build/rep_prefix
...
;   4. 中间结果放 r12-r15，退场前还原（main 靠 ret 返回）。
; ============================================================
default rel
