; ============================================================
; 文件: 06_string_ops/cmpsb.asm                            [Linux 版]
; 指令: CMPSB / REPE CMPSB
; 描述: 字符串比较 —— 硬件级逐字节比对（memcmp）
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/06_string_ops/cmpsb.asm -o build/cmpsb.o
; 链接: gcc -no-pie build/cmpsb.o -o build/cmpsb
...
main:
    ...
    mov [rbp-24], r14                   ; 退场前一律还原（main 用 ret 返回，
    mov [rbp-32], r15                   ; 破坏它们会让 libc 启动代码崩溃）
