; ============================================================
; 文件: 05_control_flow/setcc.asm                          [Linux 版]
; 指令: SETE / SETG / SETL（条件字节设置 SETcc）
; 描述: 按标志位把字节寄存器写成 0 或 1
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/05_control_flow/setcc.asm -o build/setcc.o
; 链接: gcc -no-pie build/setcc.o -o build/setcc
