; ============================================================
; 文件: 05_control_flow/loop.asm                           [Linux 版]
; 指令: LOOP
; 描述: 用 LOOP 累加 1+2+…+10 = 55
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/05_control_flow/loop.asm -o build/loop.o
; 链接: gcc -no-pie build/loop.o -o build/loop
...
;   Linux 下 RCX 是 printf 的第 4 个参数寄存器；
