; ============================================================
; 文件: 05_control_flow/jo_js_flags.asm                    [Linux 版]
; 指令: JO / JS / JP（溢出、符号、奇偶标志跳转）
; 描述: 直接盯着 OF / SF / PF 三个标志位做判断
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/05_control_flow/jo_js_flags.asm -o build/jo_js_flags.o
; 链接: gcc -no-pie build/jo_js_flags.o -o build/jo_js_flags
