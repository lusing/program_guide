; ============================================================
; 文件: 05_control_flow/je_jne.asm                         [Linux 版]
; 指令: JE / JNE + CMP
; 描述: 相等 / 不等跳转，以及 if-else 的标准汇编写法
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/05_control_flow/je_jne.asm -o build/je_jne.o
; 链接: gcc -no-pie build/je_jne.o -o build/je_jne
