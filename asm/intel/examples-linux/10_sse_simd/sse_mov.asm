; ============================================================
; 文件: 10_sse_simd/sse_mov.asm                            [Linux 版]
; 指令: MOVAPS / MOVUPS / MOVSS / MOVSD
; 描述: 数据怎么进出 XMM 寄存器 —— 对齐与不对齐的价格差
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/10_sse_simd/sse_mov.asm -o build/sse_mov.o
; 链接: gcc -no-pie build/sse_mov.o -o build/sse_mov
