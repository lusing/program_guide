; ============================================================
; 文件: 08_system_misc/nop_align.asm                       [Linux 版]
; 指令: NOP / 多字节 NOP / ALIGN 伪指令
; 描述: 空操作指令与代码对齐 —— 唯一「什么都不改」的指令
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/08_system_misc/nop_align.asm -o build/nop_align.o
; 链接: gcc -no-pie build/nop_align.o -o build/nop_align
