; ============================================================
; 文件: 02_arithmetic/inc_dec_neg.asm                      [Linux 版]
; 指令: INC / DEC / NEG
; 描述: 递增 / 递减 / 取负 —— 重点是 INC/DEC 不改变 CF 这个特性
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/02_arithmetic/inc_dec_neg.asm -o build/inc_dec_neg.o
; 链接: gcc -no-pie build/inc_dec_neg.o -o build/inc_dec_neg
