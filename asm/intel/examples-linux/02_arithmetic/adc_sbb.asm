; ============================================================
; 文件: 02_arithmetic/adc_sbb.asm                          [Linux 版]
; 指令: ADC / SBB
; 描述: 带进位加法与带借位减法 —— 128 位加减法的实现手法
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/02_arithmetic/adc_sbb.asm -o build/adc_sbb.o
; 链接: gcc -no-pie build/adc_sbb.o -o build/adc_sbb
