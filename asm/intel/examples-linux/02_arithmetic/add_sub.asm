; ============================================================
; 文件: 02_arithmetic/add_sub.asm                          [Linux 版]
; 指令: ADD / SUB
; 描述: 加法与减法 —— 寄存器 / 立即数 / 内存操作数，以及溢出时标志位的变化
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/02_arithmetic/add_sub.asm -o build/add_sub.o
; 链接: gcc -no-pie build/add_sub.o -o build/add_sub
