; ============================================================
; 文件: 09_fpu/fpu_add_sub.asm                             [Linux 版]
; 指令: FADD / FADDP / FSUB / FSUBP
; 描述: x87 浮点加减法 —— 一台上世纪留下的「栈式协处理器」
; 平台: Linux x86-64（ELF + System V AMD64）
; 汇编: nasm -I lib -f elf64 examples-linux/09_fpu/fpu_add_sub.asm -o build/fpu_add_sub.o
; 链接: gcc -no-pie build/fpu_add_sub.o -o build/fpu_add_sub
