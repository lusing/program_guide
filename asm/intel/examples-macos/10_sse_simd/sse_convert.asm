; ============================================================
; 文件: 10_sse_simd/sse_convert.asm                        [macOS 版]
...
; 汇编: nasm -I lib -f macho64 examples-macos/10_sse_simd/sse_convert.asm -o build/sse_convert.o
; 链接: clang -arch x86_64 build/sse_convert.o -o build/sse_convert
...
;
; ------------------------------------------------------------
; macOS 传参：`%f` 的值放 xmm0；`%d` 的值放 esi。两条都很直接。
; ============================================================
default rel
