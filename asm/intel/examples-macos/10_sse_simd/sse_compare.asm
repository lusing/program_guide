; ============================================================
; 文件: 10_sse_simd/sse_compare.asm                        [macOS 版]
; 指令: COMISS / COMISD / CMPPS
; 描述: 浮点比较 —— 一边出标志位、一边出掩码
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/10_sse_simd/sse_compare.asm -o build/sse_compare.o
; 链接: clang -arch x86_64 build/sse_compare.o -o build/sse_compare
...
;
; ------------------------------------------------------------
; macOS 要点：`fmt_cmpps` 有 5 个参数（格式串 + 4 个掩码），
