; ============================================================
; 文件: 01_data_movement/push_pop.asm                      [macOS 版]
; 指令: PUSH / POP
; 描述: 栈操作 —— 入栈出栈与 LIFO（后进先出）顺序
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/01_data_movement/push_pop.asm -o build/push_pop.o
; 链接: clang -arch x86_64 build/push_pop.o -o build/push_pop
