; ============================================================
; 文件: 01_data_movement/mov_extend.asm                    [macOS 版]
; 指令: MOVZX / MOVSX / MOVSXD
; 描述: 零扩展与符号扩展传送
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/01_data_movement/mov_extend.asm -o build/mov_extend.o
; 链接: clang -arch x86_64 build/mov_extend.o -o build/mov_extend
