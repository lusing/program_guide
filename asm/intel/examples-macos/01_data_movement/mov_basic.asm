; ============================================================
; 文件: 01_data_movement/mov_basic.asm                     [macOS 版]
; 指令: MOV
; 描述: MOV 指令基础 —— 立即数 / 寄存器 / 内存之间的数据传送
; 平台: macOS x86-64，Mach-O 目标文件，System V AMD64 调用约定
; 汇编: nasm -I lib -f macho64 examples-macos/01_data_movement/mov_basic.asm -o build/mov_basic.o
; 链接: clang -arch x86_64 build/mov_basic.o -o build/mov_basic
...
;   macOS  : rdi rsi rdx rcx r8 r9，没有影子空间
