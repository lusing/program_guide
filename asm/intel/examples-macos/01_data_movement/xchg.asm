; ============================================================
; 文件: 01_data_movement/xchg.asm                          [macOS 版]
; 指令: XCHG
; 描述: XCHG 交换指令 —— 寄存器间 / 寄存器与内存之间交换
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/01_data_movement/xchg.asm -o build/xchg.o
; 链接: clang -arch x86_64 build/xchg.o -o build/xchg
...
;      而 macOS 下 _main 是 libSystem 启动代码调用进来的普通函数，
