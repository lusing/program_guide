; ============================================================
; 文件: 03_logic_bitwise/shifts.asm                        [macOS 版]
; 指令: SHL / SHR / SAR / ROL / ROR
; 描述: 移位与循环移位
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/03_logic_bitwise/shifts.asm -o build/shifts.o
; 链接: clang -arch x86_64 build/shifts.o -o build/shifts
