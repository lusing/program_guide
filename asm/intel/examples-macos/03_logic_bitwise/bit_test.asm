; ============================================================
; 文件: 03_logic_bitwise/bit_test.asm                      [macOS 版]
; 指令: BT / BTS / BTR / BTC
; 描述: 位测试与「测试并修改」指令
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/03_logic_bitwise/bit_test.asm -o build/bit_test.o
; 链接: clang -arch x86_64 build/bit_test.o -o build/bit_test
