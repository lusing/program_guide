; ============================================================
; 文件: 03_logic_bitwise/bit_scan.asm                      [macOS 版]
; 指令: BSF / BSR
; 描述: 位扫描 —— 找最低 / 最高的那个置 1 位
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/03_logic_bitwise/bit_scan.asm -o build/bit_scan.o
; 链接: clang -arch x86_64 build/bit_scan.o -o build/bit_scan
