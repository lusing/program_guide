; ============================================================
; 文件: 04_comparison/cmp.asm                              [macOS 版]
; 指令: CMP
; 描述: 比较指令 —— 做减法但不写回结果，只设标志位
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/04_comparison/cmp.asm -o build/cmp.o
; 链接: clang -arch x86_64 build/cmp.o -o build/cmp
