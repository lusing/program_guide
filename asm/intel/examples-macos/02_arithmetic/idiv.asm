; ============================================================
; 文件: 02_arithmetic/idiv.asm                             [macOS 版]
; 指令: IDIV
; 描述: 有符号除法 —— 除之前用 CQO 把符号位扩展进 RDX
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/02_arithmetic/idiv.asm -o build/idiv.o
; 链接: clang -arch x86_64 build/idiv.o -o build/idiv
