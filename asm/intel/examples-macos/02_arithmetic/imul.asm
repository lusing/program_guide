; ============================================================
; 文件: 02_arithmetic/imul.asm                             [macOS 版]
; 指令: IMUL
; 描述: 有符号乘法 —— 单操作数 / 双操作数 / 三操作数三种形式
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/02_arithmetic/imul.asm -o build/imul.o
; 链接: clang -arch x86_64 build/imul.o -o build/imul
