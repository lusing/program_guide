; ============================================================
; 文件: 09_fpu/fpu_mul_div.asm                             [macOS 版]
; 指令: FMUL / FMULP / FDIV / FDIVP
; 描述: x87 浮点乘除法 —— 顺便用 22/7 演一次圆周率近似
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/09_fpu/fpu_mul_div.asm -o build/fpu_mul_div.o
; 链接: clang -arch x86_64 build/fpu_mul_div.o -o build/fpu_mul_div
...
;
; ------------------------------------------------------------
; macOS（SysV）传浮点参数只要一条 movsd xmm0, [mem]，
