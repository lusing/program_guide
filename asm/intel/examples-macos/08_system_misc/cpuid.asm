; ============================================================
; 文件: 08_system_misc/cpuid.asm                           [macOS 版]
; 指令: CPUID
; 描述: 让 CPU 自报家门 —— 厂商字符串、型号、特性标志
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/08_system_misc/cpuid.asm -o build/cpuid.o
; 链接: clang -arch x86_64 build/cpuid.o -o build/cpuid
...
;   一定要把 EBX 还原成调用者那会儿的值，否则 _main 一 ret，
;   dyld 立刻用坏掉的 rbx 去访存并崩溃。
