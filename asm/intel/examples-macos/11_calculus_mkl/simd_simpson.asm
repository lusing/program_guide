; ============================================================
; 文件: 11_calculus_mkl/simd_simpson.asm                   [macOS 版]
; 指令: MOVUPS / ADDPS / MULPS / DIVPS / SHUFPS
; 描述: 辛普森法则向量化 —— 一个交错的权重向量干掉所有分支
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/11_calculus_mkl/simd_simpson.asm -o build/simd_simpson.o
; 链接: clang -arch x86_64 build/simd_simpson.o -o build/simd_simpson
