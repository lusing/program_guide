; ============================================================
; 文件: 06_string_ops/scasb.asm                            [macOS 版]
; 指令: SCASB / REPNE SCASB
; 描述: 字符串扫描 —— 用硬件循环找字符
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/06_string_ops/scasb.asm -o build/scasb.o
; 链接: clang -arch x86_64 build/scasb.o -o build/scasb
...
;
; macOS 上 RDI 是第 1 个参数寄存器，RCX 是第 4 个，
