; ============================================================
; 文件: 06_string_ops/stosb.asm                            [macOS 版]
; 指令: STOSB / REP STOSB
; 描述: 字符串存储填充 —— 等价于 memset
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/06_string_ops/stosb.asm -o build/stosb.o
; 链接: clang -arch x86_64 build/stosb.o -o build/stosb
