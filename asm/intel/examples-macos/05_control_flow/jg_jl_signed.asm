; ============================================================
; 文件: 05_control_flow/jg_jl_signed.asm                   [macOS 版]
; 指令: JG / JGE / JL / JLE（有符号条件跳转）
; 描述: 有符号比较跳转，用正负数对比
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/05_control_flow/jg_jl_signed.asm -o build/jg_jl_signed.o
; 链接: clang -arch x86_64 build/jg_jl_signed.o -o build/jg_jl_signed
