; ============================================================
; 文件: 05_control_flow/cmov.asm                           [macOS 版]
; 指令: CMOVG / CMOVL（条件移动 CMOVcc）
; 描述: 无分支（branchless）实现 min / max
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/05_control_flow/cmov.asm -o build/cmov.o
; 链接: clang -arch x86_64 build/cmov.o -o build/cmov
