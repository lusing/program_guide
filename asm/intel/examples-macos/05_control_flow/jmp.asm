; ============================================================
; 文件: 05_control_flow/jmp.asm                            [macOS 版]
; 指令: JMP
; 描述: 无条件跳转 —— 跳过一段代码
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/05_control_flow/jmp.asm -o build/jmp.o
; 链接: clang -arch x86_64 build/jmp.o -o build/jmp
