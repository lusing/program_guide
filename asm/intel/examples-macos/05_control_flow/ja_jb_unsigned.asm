; ============================================================
; 文件: 05_control_flow/ja_jb_unsigned.asm                 [macOS 版]
; 指令: JA / JAE / JB / JBE（无符号条件跳转）
; 描述: 同一个 CMP，换成无符号跳转会得出完全相反的结论
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/05_control_flow/ja_jb_unsigned.asm -o build/ja_jb_unsigned.o
; 链接: clang -arch x86_64 build/ja_jb_unsigned.o -o build/ja_jb_unsigned
