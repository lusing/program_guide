; ============================================================
; 文件: 07_stack_ops/pushf_popf.asm                        [macOS 版]
; 指令: PUSHFQ / POPFQ
; 描述: 把整个 RFLAGS 存进栈、再原样装回去
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/07_stack_ops/pushf_popf.asm -o build/pushf_popf.o
; 链接: clang -arch x86_64 build/pushf_popf.o -o build/pushf_popf
; 对照: examples/07_stack_ops/pushf_popf.asm
;
; 本例用了 lib/mac_io.inc 里的 m_putflags —— 给一个 RFLAGS 值，
