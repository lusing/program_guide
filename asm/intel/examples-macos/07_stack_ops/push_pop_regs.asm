; ============================================================
; 文件: 07_stack_ops/push_pop_regs.asm                     [macOS 版]
; 指令: PUSH imm / POP r64
; 描述: 栈的后进先出（LIFO）特性
; 平台: macOS x86-64（Mach-O + System V AMD64）
; 汇编: nasm -I lib -f macho64 examples-macos/07_stack_ops/push_pop_regs.asm -o build/push_pop_regs.o
; 链接: clang -arch x86_64 build/push_pop_regs.o -o build/push_pop_regs
...
;      进函数先存到栈上，ret 之前必须原样还原（否则 dyld 崩）；
