...
%%
%% 编译：
%%   erlc -Werror -Wall -o build/08_binaries examples/08_binaries/08_binaries.erl
%% 运行：
%%   erl -noshell -pa build/08_binaries -run '08_binaries' main -s init stop
%% ============================================================
-module('08_binaries').

-export([main/0, parse_tlv/1, encode_tlv/2, parse_utf8/1, png_size/1,
         take_len_prefixed/1, as_signed/1, as_unsigned/1, as_double/1]).
