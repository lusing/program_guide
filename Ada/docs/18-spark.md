...
> 示例：[`examples/ch18_spark.adb`](../examples/ch18_spark.adb)
...
ch18_spark.adb:27:07: info: precondition proved      [evidence]
ch18_spark.adb:35:07: info: loop invariant proved    [induction]
ch18_spark.adb:37:07: info: loop variant proved      [monotonic]
ch18_spark.adb:42:14: info: postcondition proved     [z3]
ch18_spark.adb:75:07: warning: postcondition might fail [not proved]
...
完整代码见 [examples/ch18_spark.adb](../examples/ch18_spark.adb)，演示 **5 个符合 SPARK 子集的函数/过程**：
...
gnatmake -gnata -o examples\ch18_spark.exe examples\ch18_spark.adb
.\examples\ch18_spark.exe
```

```bash
# Linux / macOS
gnatmake -gnata -o ch18_spark examples/ch18_spark.adb
./ch18_spark
```
...
1. 创建项目文件 `ch18_spark.gpr`：

```ada
project Ch18_Spark is
   for Source_Dirs use ("src");
   for Object_Dir  use "obj";
   for Exec_Dir    use "bin";
   for Main        use ("ch18_spark.adb");
...
```bash
gnatprove -P ch18_spark.gpr --level=2 --report=all
```
...
---
上一章：[17 契约](17-contracts.md) ｜ 下一章：[19 附录](19-appendix.md) ｜ 返回：[README](../README.md)
