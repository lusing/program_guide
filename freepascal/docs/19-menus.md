...
`SimpleText` 属性在 SimplePanel=True 时用。24 章记事本+ 的行列号/字数统计就住这里。

## 6. 标准对话框的菜单命令化

真实程序里 ActOpen 的 OnExecute 大概长这样（20 章的预告）：
...
---
上一章：[18 布局与高 DPI](18-layout.md) ｜ 下一章：[20 对话框与文件](20-dialogs.md) ｜ 返回：[README](../README.md)
