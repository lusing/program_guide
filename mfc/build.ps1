...
$atlmfcInclude = Join-Path $msvcRoot "atlmfc\include"
...
$windowsSdkInclude = Join-Path $windowsSdkRoot "Include\10.0.26100.0"
...
$windowsSdkUmLib = Join-Path $windowsSdkRoot "Lib\10.0.26100.0\um\x64"
$windowsSdkUcrtLib = Join-Path $windowsSdkRoot "Lib\10.0.26100.0\ucrt\x64"
